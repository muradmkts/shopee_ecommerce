    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                top: MediaQuery.sizeOf(context).height / 50.75,
                bottom: MediaQuery.sizeOf(context).height / 40.6),
            child: Wrap(
              children: [
                ElevatedButton(
                    onPressed: () {},
                    style: ElevatedButton.styleFrom(
                        ...
                        fixedSize: Size(MediaQuery.sizeOf(context).width / 2.67,
                            MediaQuery.sizeOf(context).height / 23.2),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(100),
                        )),
              ...
              children: [
                Column(
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          child: Center(
                            ...
                            "12",
                            style: TextStyle(
                                color: ColorTheme.primaryWhite, fontSize: 21),
                          )),
                          height: MediaQuery.sizeOf(context).width / 6.24,
                          width: MediaQuery.sizeOf(context).width / 6.24,
                          decoration: BoxDecoration(
                            color: ColorTheme.primaryBlue,
                            shape: BoxShape.circle,
                          ),
                    ...
                    Padding(
                      padding:  EdgeInsets.only(top: MediaQuery.sizeOf(context).height/40.6,
                      ),
                      child: Text(
                        "Ordered",
                        style: TextStyle(
                            color: ColorTheme.primaryBlack, fontSize: 16, fontWeight: FontWeight.bold),
                      ),
                    ),
                  ],
                ),
